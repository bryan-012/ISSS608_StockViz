...
Our stock data will be retrieved from Yahoo Finance using quantmod. In Shiny App, Data will be pulled real-time according to user's selection. For now FANG data will be used to demonstrate EDA and CDA.
